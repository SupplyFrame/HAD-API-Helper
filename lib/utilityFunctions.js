...
/**
 * Creates the API endpoint given a set of parameters
 * @param {string} endpoint API endpoint
 * @param {number} id item ID
 * @param {object} options Additional query options
 * @param additionalNouns Additional endpoint nouns
 * @returns {string} Complete API endpoint with query params
 */
